...
function bmrWomen(w,h,a){
	var bmr = 665 + (9.60*w)+(1.8*h)-(4.7*a);
	return bmr;
}

function bmrMen(w,h,a){
	var bmr = 66 + (13.70*w)+(5*h) - (6.8*a);
	return bmr;
}
...
calculate.addEventListener("click", function(){
	...
	if (gender==0){
		...
		daily.textContent = "BMI anda adalah " + bmr + " dan anda perlu mengkonsumsi " + activity + " kalori untuk menjaga berat badan anda"
